...
const products = [
  { id: 1, name: "Solitaire Elegance Ring",  price: "$1,250", rating: 4.5, reviews: 124, img: "/collections/collections-bestsellers-1.jpg" },
  { id: 2, name: "Teardrop Halo Necklace",   price: "$1,480", rating: 4.5, reviews: 98,  img: "/collections/collections-bestsellers-2.jpg" },
  { id: 3, name: "Classic Diamond Studs",    price: "$980",   rating: 4.5, reviews: 210, img: "/collections/collections-bestsellers-3.jpg" },
  { id: 4, name: "Timeless Tennis Bracelet", price: "$2,150", rating: 4.5, reviews: 156, img: "/collections/collections-bestsellers-4.jpg" },
  { id: 5, name: "Infinity Love Ring",       price: "$1,320", rating: 4.5, reviews: 75,  img: "/collections/collections-bestsellers-5.jpg" },
  { id: 6, name: "Knot Diamond Bangle",      price: "$1,780", rating: 4.5, reviews: 112, img: "/collections/collections-bestsellers-6.jpg" },
  { id: 7, name: "Pear Drop Earrings",       price: "$1,590", rating: 4.5, reviews: 87,  img: "/collections/collections-bestsellers-7.jpg" },
  { id: 8, name: "Cushion Halo Pendant",     price: "$1,350", rating: 4.5, reviews: 101, img: "/collections/collections-bestsellers-8.jpg" },
];
  ...
  return (
    <div className="flex gap-0.5">
      {[1, 2, 3, 4, 5].map((s) => (
        <span
          key={s}
          className={`text-sm ${s <= Math.floor(rating) ? "text-[#D4A017]" : s - 0.5 === rating ? "text-[#D4A017]" : "text-gray-300"}`}
        >
          ★
        </span>
      ))}
    ...
    <>
      <section className="bg-[#FAF8F5] py-14 px-4">
        <div className="max-w-7xl mx-auto">
          <SectionHeading title="BEST SELLERS" className="mb-3" />
          <p className="text-center text-[#666] text-sm mt-2 mb-10">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex items-center gap-1 ml-2">
                <button
                  ...
                  className={`p-1.5 border ${viewGrid ? "border-[#7B3030] text-[#7B3030]" : "border-gray-200 text-[#aaa]"}`}
                >
                  <LayoutGrid size={14} />
                </button>
                <button
