    ...
    <>
      ...
      <section className="bg-white py-16 px-4">
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          {/* Left — Contact Info */}
          <div>
            <h2 className="font-serif text-2xl font-bold tracking-[0.1em] text-[#1a1a1a] mb-2">
              GET IN TOUCH
            </h2>
            ...
            <ul className="flex flex-col gap-6">
              <li className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-[13px] text-[#555]">hello@renorajewels.com</p>
                </div>
              </li>
              <li className="flex items-start gap-4">
                <div className="w-9 h-9 border border-gray-200 flex items-center justify-center shrink-0">
                ...
                <div>
                  ...
                  <p className="text-[13px] text-[#555]">+1 (555) 123-4567</p>
                </div>
              </li>
              <li className="flex items-start gap-4">
                <div className="w-9 h-9 border border-gray-200 flex items-center justify-center shrink-0">
              ...
              <li className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-[13px] text-[#555]">255 Diamond Street, New York,<br />NY 10001, USA</p>
                </div>
              </li>
            </ul>
            ...
            <div className="mt-8">
              ...
              <div className="flex gap-2">
                ...
                {/* Diamond */}
                <SocialIcon>
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><polygon points="12 2 22 8.5 22 15.5 12 22 2 15.5 2 8.5 12 2"/><line x1="12" y1="2" x2="12" y2="22"/><line x1="2" y1="8.5" x2="22" y2="8.5"/></svg>
                </SocialIcon>
              </div>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <input
                ...
                required
                className="border border-gray-200 px-4 py-3 text-[13px] outline-none focus:border-[#7B3030] placeholder:text-[#bbb] transition-colors"
              />
              <input
                name="email"
                type="email"
            ...
            <textarea
              ...
              required
              rows={8}
              className="border border-gray-200 px-4 py-3 text-[13px] outline-none focus:border-[#7B3030] placeholder:text-[#bbb] transition-colors resize-none"
            />
            <button
              type="submit"
              className="bg-[#7B3030] text-white text-[11px] tracking-[0.25em] font-semibold py-4 hover:bg-[#5e2424] transition-colors"
            >
              SEND MESSAGE
            </button>
          </form>
